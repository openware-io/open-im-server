package com.gvchat.im.accessws.handler;
...
import com.gvchat.im.accessws.message.MessageAcceptance;
import com.gvchat.im.accessws.message.MqMessageGateway;
...
import com.gvchat.protocol.ws.dto.ReadReceiptDto;
import com.gvchat.protocol.ws.dto.RecallMessageDto;
import com.gvchat.protocol.ws.dto.SendMessageDto;
import com.gvchat.protocol.ws.dto.WsRtcSignalDto;
...
public class ImWebSocketHandler extends TextWebSocketHandler {
  ...
  private void handleChatSend(WebSocketSession session, Long userId, String username, Map<String, Object> data)
    ...
    if (dto.getChatType() == com.gvchat.common.enums.ChatType.SECRET) {
      log.warn(
