...
class MediaContentDispositionFilterTest {
    ...
    void publicMediaPathIsRecognisedByPrefix() {
        assertThat(MediaContentDispositionFilter.isPublicMedia("/api/v1/media-public/gv-media-public/a/b.png")).isTrue();
        assertThat(MediaContentDispositionFilter.isPublicMedia("/api/v1/media/12/access")).isFalse();
        assertThat(MediaContentDispositionFilter.isPublicMedia("/media-public/gv-media-public/a/b.png")).isFalse();
