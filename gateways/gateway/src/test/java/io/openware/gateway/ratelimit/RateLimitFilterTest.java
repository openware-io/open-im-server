...
class RateLimitFilterTest {
  ...
  void passesThroughPublicMediaReadsWithoutThrottling() {
    ServerWebExchange exchange = exchange("/api/v1/media-public/open-media-public/saas/t100/202609/a.png", HttpMethod.GET);
    newFilter(null).filter(exchange, chain).block();
    verify(chain).filter(exchange);
  }
  ...
  void stillThrottlesNonReadMethodsOnPublicMediaPath() {
    ServerWebExchange exchange = exchange("/api/v1/media-public/open-media-public/a.png", HttpMethod.POST);
