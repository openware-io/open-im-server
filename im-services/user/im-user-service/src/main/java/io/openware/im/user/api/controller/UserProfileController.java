...
import io.openware.im.user.api.dto.request.ChangePasswordRequest;
import io.openware.im.user.api.dto.request.DeleteAccountRequest;
import io.openware.im.user.api.dto.request.SearchUserRequest;
import io.openware.im.user.api.dto.request.SelfDestructPolicyRequest;
import io.openware.im.user.api.dto.request.UpdateNotificationSettingsRequest;
import io.openware.im.user.api.dto.request.UpdatePrivacySettingsRequest;
import io.openware.im.user.api.dto.request.UpdateProfileRequest;
import io.openware.im.user.api.dto.response.NotificationSettingsResponse;
import io.openware.im.user.api.dto.response.PrivacySettingsResponse;
import io.openware.im.user.api.dto.response.SelfDestructPolicyResponse;
import io.openware.im.user.api.dto.response.UserProfileResponse;
import io.openware.im.user.application.account.SelfDestructApplicationService;
...
import io.openware.im.user.application.privacysetting.PrivacySettingApplicationService;
import io.openware.im.user.application.profile.ProfileApplicationService;
import io.openware.im.user.application.profile.command.ChangePasswordCommand;
import io.openware.im.user.application.profile.command.DeleteAccountCommand;
import io.openware.im.user.application.profile.command.UpdateProfileCommand;
