...
import io.openware.im.user.api.converter.FriendApiConverter;
import io.openware.im.user.api.dto.request.HandleFriendRequest;
import io.openware.im.user.api.dto.request.SendFriendRequest;
import io.openware.im.user.api.dto.request.UpdateFriendRequest;
...
import io.openware.im.user.application.social.FriendApplicationService;
import io.openware.im.user.application.social.command.HandleFriendRequestCommand;
import io.openware.im.user.application.social.command.SendFriendRequestCommand;
import io.openware.im.user.application.social.command.UpdateFriendCommand;
