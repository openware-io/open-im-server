package com.gvchat.im.user.infra.persistence.openplatform.repository;
...
import com.gvchat.im.user.infra.persistence.openplatform.converter.OpenPlatformPersistenceConverter;
import com.gvchat.im.user.infra.persistence.openplatform.mapper.OpenApplicationMapper;
import com.gvchat.im.user.infra.persistence.openplatform.mapper.OpenApplicationScopeMapper;
import com.gvchat.im.user.infra.persistence.openplatform.mapper.UserOidcRedirectUriMapper;
...
import com.gvchat.im.user.infra.persistence.openplatform.po.UserOidcRedirectUriPo;
