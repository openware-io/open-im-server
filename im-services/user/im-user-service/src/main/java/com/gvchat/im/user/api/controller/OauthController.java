...
import com.gvchat.im.user.api.dto.request.OauthTokenRequest;
...
public class OauthController {
  ...
  public ResponseEntity<Void> authorize(
    ...
    if (!"code".equals(responseType)) {
      throw new com.gvchat.common.exception.ApiException(HttpStatus.BAD_REQUEST.value(), "unsupported_response_type");
    }
