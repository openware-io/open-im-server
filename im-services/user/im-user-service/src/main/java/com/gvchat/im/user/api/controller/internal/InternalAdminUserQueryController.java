...
import com.gvchat.im.user.api.admin.ChangeUserStatusRequest;
...
import com.gvchat.im.user.application.admin.AdminUserDeletionApplicationService;
import com.gvchat.im.user.application.admin.AdminUserQueryApplicationService;
import com.gvchat.im.user.application.admin.query.AdminFriendListQuery;
import com.gvchat.im.user.application.admin.query.AdminUserListQuery;
