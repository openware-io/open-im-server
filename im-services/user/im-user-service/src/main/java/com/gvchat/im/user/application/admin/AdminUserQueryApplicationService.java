...
public class AdminUserQueryApplicationService {
  ...
  private static com.gvchat.im.user.domain.social.model.FriendStatus toFriendStatus(FriendStatus status) {
    return status == null ? null : com.gvchat.im.user.domain.social.model.FriendStatus.valueOf(status.name());
  }
