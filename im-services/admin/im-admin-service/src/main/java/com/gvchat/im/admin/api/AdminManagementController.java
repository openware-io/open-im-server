...
import com.gvchat.im.admin.application.AdminManagementApplicationService.ConfigurationChange;
import com.gvchat.im.admin.application.AdminManagementApplicationService.ItemChange;
import com.gvchat.im.admin.application.AdminManagementApplicationService.ItemPatch;
import com.gvchat.im.admin.application.AdminManagementApplicationService.TypeSort;
import com.gvchat.im.admin.application.AdminManagementApplicationService.WordPatch;
...
public class AdminManagementController {
  ...
  private com.gvchat.common.enums.ViolationAction violationAction(String value) { if (value == null || value.isBlank()) return null; try { return com.gvchat.common.enums.ViolationAction.fromValue(value); } catch (IllegalArgumentException exception) { throw new com.gvchat.common.exception.ApiException(com.gvchat.common.http.HttpStatusCodes.BAD_REQUEST,"Invalid violation action"); } }
  private com.gvchat.common.enums.ReportStatus reportStatus(String value) { if (value == null || value.isBlank()) return null; try { return com.gvchat.common.enums.ReportStatus.fromValue(value); } catch (IllegalArgumentException exception) { throw new com.gvchat.common.exception.ApiException(com.gvchat.common.http.HttpStatusCodes.BAD_REQUEST,"Invalid report status"); } }
