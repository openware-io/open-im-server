...
class FriendAcceptedMessageApplicationServiceTest {
  ...
  private final com.gvchat.im.message.domain.message.repository.UserDeletedMessageRepository deletedMessages =
      Mockito.mock(com.gvchat.im.message.domain.message.repository.UserDeletedMessageRepository.class);
