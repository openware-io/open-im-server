...
import com.gvchat.im.message.api.converter.MessageApiConverter;
import com.gvchat.im.message.api.dto.request.DeleteForMeRequest;
import com.gvchat.im.message.api.dto.request.DeleteMessageRequest;
import com.gvchat.im.message.api.dto.request.EditMessageRequest;
import com.gvchat.im.message.api.dto.request.ClearPrivateChatRequest;
import com.gvchat.im.message.api.dto.request.ClearGroupChatRequest;
import com.gvchat.im.message.api.dto.request.MarkMessagesReadRequest;
import com.gvchat.im.message.api.dto.request.MessageHistoryRequest;
import com.gvchat.im.message.api.dto.request.MessageSyncRequest;
import com.gvchat.im.message.api.dto.request.SearchMessagesRequest;
import com.gvchat.im.message.api.dto.response.ConversationUnreadResponse;
import com.gvchat.im.message.api.dto.response.DeleteMessageResponse;
import com.gvchat.im.message.api.dto.response.EditMessageResponse;
import com.gvchat.im.message.api.dto.response.MarkMessagesReadResponse;
import com.gvchat.im.message.api.dto.response.MessageResponse;
import com.gvchat.im.message.api.dto.response.MessageSyncResponse;
import com.gvchat.im.message.api.dto.response.SearchMessagesResponse;
import com.gvchat.im.message.api.dto.response.UnreadCountResponse;
