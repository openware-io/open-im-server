...
public class ConversationGroupMembershipAdapter implements GroupMembershipPort {
  ...
  public GroupMembershipPort.GroupMessageRecipientSnapshot messageRecipientSnapshot(long groupId, long senderId) {
    com.gvchat.im.conversation.api.authorization.GroupMessageRecipientSnapshot response = restClient.post()
        ...
        .retrieve().body(com.gvchat.im.conversation.api.authorization.GroupMessageRecipientSnapshot.class);
