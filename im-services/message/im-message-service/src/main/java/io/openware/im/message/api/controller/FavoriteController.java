...
import io.openware.im.message.api.converter.FavoriteApiConverter;
import io.openware.im.message.api.dto.request.AddFavoriteRequest;
import io.openware.im.message.api.dto.request.AddFavoritesBatchRequest;
...
import io.openware.im.message.api.dto.response.OperationResponse;
import io.openware.im.message.application.favorite.FavoriteApplicationService;
