...
import io.openware.im.message.application.result.AdminMessagePageResult;
import io.openware.im.message.application.result.AdminMessageStatsResult;
import io.openware.im.message.application.result.MarkMessagesReadResult;
...
import io.openware.im.message.application.result.SyncedMessageResult;
...
import io.openware.im.message.domain.moderation.ModerationWordFilter;
...
public class MessageApplicationService {
  ...
  private final io.openware.im.message.domain.message.repository.UserConversationClearRepository userConversationClearRepository;
  private final io.openware.im.message.domain.message.port.HotMessageProjectionPort hotMessageProjectionPort;
  ...
  public List<MessageResult> listChannelMessages(long userId, long channelId, long afterSeq, int limit) {
    ...
    String conversationId = io.openware.protocol.mq.support.ConversationIds.channelConversation(channelId);
