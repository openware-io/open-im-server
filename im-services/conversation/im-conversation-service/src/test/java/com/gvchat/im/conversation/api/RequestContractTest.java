package com.gvchat.im.conversation.api;
...
class RequestContractTest {
  ...
  private static final Class<?>[] CONTRACTS = {
    com.gvchat.im.conversation.api.secretchat.CreateSecretChatRequest.class,
    com.gvchat.im.conversation.api.secretchat.SubmitHandshakeRequest.class,
    com.gvchat.im.conversation.api.secretchat.SetDestroyPolicyRequest.class,
    com.gvchat.im.conversation.api.channel.CreateChannelRequest.class,
  };

  @Test
  void createSecretChatRequestMustKeepUserBField() throws Exception {
    Class<?> type = com.gvchat.im.conversation.api.secretchat.CreateSecretChatRequest.class;
  ...
  void setDestroyPolicyRequestMustKeepPolicyField() throws Exception {
    Class<?> type = com.gvchat.im.conversation.api.secretchat.SetDestroyPolicyRequest.class;
  ...
  void submitHandshakeRequestMustKeepPublicKeyField() throws Exception {
    Class<?> type = com.gvchat.im.conversation.api.secretchat.SubmitHandshakeRequest.class;
  ...
  void createChannelRequestMustKeepNameField() throws Exception {
    Class<?> type = com.gvchat.im.conversation.api.channel.CreateChannelRequest.class;
