...
public class OrderItemController {
    ...
    private OrderItemPo doAddItem(Long orderId, AddItemRequest req) {
        ...
        if (tenantId == null) { throw new com.gvchat.common.exception.ApiException(401, "TENANT_CONTEXT_MISSING", "缺少租户上下文"); }
    ...
    private OrderPo requireOrder(Long orderId) {
        ...
        if (order == null) {
            if (orderMapper.selectTenantIdById(orderId) != null) {
                throw new com.gvchat.common.exception.ApiException(403, "TENANT_SCOPE_DENIED", "无权访问其他租户的订单");
            }
