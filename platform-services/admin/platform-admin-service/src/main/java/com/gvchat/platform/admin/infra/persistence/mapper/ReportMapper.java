 ...
 * {@code com.gvchat.infrastructure.time.ReportTimeBuckets}。因此本 Mapper 里**所有**切日表达式都是
...
public interface ReportMapper {
     ...
     *       跨零点通宵场次仍按 {@link com.gvchat.infrastructure.time.ReportTimeBuckets} 的切点归前一营业日；</li>
