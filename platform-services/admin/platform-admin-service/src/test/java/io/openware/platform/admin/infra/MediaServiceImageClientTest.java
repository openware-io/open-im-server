...
class MediaServiceImageClientTest {
  ...
  void sendsRawImageBodyWithSignedQueryAndMapsResponse() {
    ...
    responseBody = """
        {"url":"/api/v1/media-public/open-media-public/saas/t100-s7/202609/abc.png",\
        "objectKey":"saas/t100-s7/202609/abc.png","bucket":"open-media-public","contentType":"image/png","size":9}""";
    ...
    assertEquals("/api/v1/media-public/open-media-public/saas/t100-s7/202609/abc.png", uploaded.url());
