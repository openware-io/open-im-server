...
class AdminTenantContextTokenSignerTest {
  ...
  void malformedContextTokenIsReportedAs401() {
    String wrongKey = Jwts.builder().subject("900").issuer("open-saas-identity")
        .audience().add("open-saas-services").and().claim("tenantId", 100L)
  ...
  void contextTokenWithoutTenantIdIsReportedAs401() {
    String withoutTenant = Jwts.builder().subject("900").issuer("open-saas-identity")
  ...
  private static String expiredContextToken() {
    ...
    return Jwts.builder().subject("900").issuer("open-saas-identity")
        .audience().add("open-saas-services").and().claim("tenantId", 100L)
