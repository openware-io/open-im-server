package io.openware.platform.marketing.config;
...
public class PlatformTenantLineHandler implements TenantLineHandler {
    ...
    public boolean ignoreTable(String t) {
        return t.startsWith("idt_") || t.equals("tnt_tenant") || t.equals("tnt_business_type")
                || t.equals("iam_permission") || t.endsWith("_event_outbox") || t.endsWith("_event_consumed") || t.equals("mkt_campaign") || t.equals("mkt_consent");
    }
}
