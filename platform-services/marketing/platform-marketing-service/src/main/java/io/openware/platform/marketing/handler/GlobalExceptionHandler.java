package io.openware.platform.marketing.handler;
...
/**
 * 营销（优惠券/活动）服务统一异常出口：业务异常 + Spring MVC 框架 4xx 异常 + 500 兜底，全部返回 {code, message}。
 *
 * <p>此前本 advice 只映射 {@link ApiException}：框架异常（未知路径、方法不支持、缺请求头）会退化成
 * Spring 默认错误体，非业务异常也没有兜底日志。这里补齐显式映射与兜底堆栈。
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleGeneric(Exception ex, HttpServletRequest request) {
        log.error("Unhandled marketing-service exception, uri={}",
