...
import io.openware.common.media.media.MediaUploadSessionService;
...
public class MediaUploadSessionController {
  ...
  private void requireIdempotencyKey(String idempotencyKey) {
    try {
      ...
      throw new io.openware.common.exception.ApiException(
          io.openware.common.http.HttpStatusCodes.BAD_REQUEST,
