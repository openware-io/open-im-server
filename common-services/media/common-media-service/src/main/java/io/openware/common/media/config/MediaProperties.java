package io.openware.common.media.config;
 ...
 *
 * <ul>
 *   <li>{@code media.public-bucket}：公开只读桶，默认 {@code open-media-public}。</li>
...
public record MediaProperties(
  ...
  public MediaProperties {
    publicBucket = blankToDefault(publicBucket, "open-media-public");
